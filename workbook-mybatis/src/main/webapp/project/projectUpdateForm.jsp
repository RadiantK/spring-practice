	...
	<form action="update.do" method="post">
		<ul>
			<li>
				...
				<input type="text" name="no" id="no" size="5" 
				value="${project.no}" readonly/>
			</li>
			<li>
			...
			<li>
				...
				placeholder="2020-01-01" value="${project.startDate}"/>
			</li>
			<li>
				<label for="edate">종료일</label>
				<input type="text" name="endDate" id="edate" 
				placeholder="2020-01-01" value="${project.endDate}"/>
			</li>
			<li>
